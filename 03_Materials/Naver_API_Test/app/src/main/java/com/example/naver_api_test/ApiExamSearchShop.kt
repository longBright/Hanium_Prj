...
object ApiExamSearchShop {
    var clientId = "CXzasaVolHGbyamf5tm9" //애플리케이션 클라이언트 아이디값"
    var clientSecret = "ExgT_RPB7p" //애플리케이션 클라이언트 시크릿값"
    fun main() {
        var text: String? = null
        text = try {
            URLEncoder.encode("마스크", "UTF-8")
        ...
        val responseBody = ApiExamSearchShop[apiURL, requestHeaders]
