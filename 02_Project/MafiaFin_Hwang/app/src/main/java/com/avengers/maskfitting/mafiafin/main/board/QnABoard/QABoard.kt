...
private var mBinding: FragmentQaBoardBinding? = null
...
class Board : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.board1.setOnClickListener {
            var intent = Intent(this, BulletinBoard::class.java)
    ...
    override fun onCreateView(
        ...
        // view 객체 생성
        val view = inflater.inflate(R.layout.fragment_qa_board, container, false)
